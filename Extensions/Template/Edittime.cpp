...
//	PropData_Color		(PROPID_COLOR,		IDS_PROP_COLOR,			IDS_PROP_COLOR_INFO),
	...
	PropData_Group (Version_Group,(UINT)"Extension Version",(UINT)"",),
	PropData_StaticString(Version,(UINT)"Version Number",(UINT)"Indicates the current version of the extension"),
...
LPVOID WINAPI DLLExport GetPropValue(LPMV mV, LPEDATA edPtr, UINT nPropID)
{
	...
	case Version:
		return new CPropDataValue("May 8th, 2014");
